...
public class Database {
     ...
     * Attributes
     */
    public static final String DRIVERS_DATA_PATH = "data/Drivers.txt";
    public static final String MANAGERS_DATA_PATH = "data/Managers.txt";
    public static final String PASSENGERS_DATA_PATH = "data/Passengers.txt";
    public static final String TRIPS_DATA_PATH = "data/Trips.txt";
    public static final String VEHICLES_DATA_PATH = "data/Vehicles.txt";
    ...
    public void write() throws IOException {
        writeList(tripList, TRIPS_DATA_PATH);
        writeUsers();
        writeList(vehicleList, VEHICLES_DATA_PATH);
    }

    public void writeUsers() throws IOException {
        writeList(passengersList, PASSENGERS_DATA_PATH);
        writeList(driverList, DRIVERS_DATA_PATH);
        writeList(managerList, MANAGERS_DATA_PATH);
    }
    ...
    public void loadVehicles() throws IOException {
        setBufferedReader(VEHICLES_DATA_PATH);
    ...
    public void loadTrips() throws IOException {
        setBufferedReader(TRIPS_DATA_PATH);
        while (bufferedReader.ready()) {
    ...
    public void loadDrivers() throws IOException {
        setBufferedReader(DRIVERS_DATA_PATH);
        while (bufferedReader.ready()) {
    ...
    public void loadPassengers() throws IOException {
        setBufferedReader(PASSENGERS_DATA_PATH);
        while (bufferedReader.ready()) {
    ...
    public void loadManagers() throws IOException {
        setBufferedReader(MANAGERS_DATA_PATH);
        while (bufferedReader.ready()) {
